$('.welcomslider').slick({
    infinite: true,
    prevArrow: '<button type= "button" class="slick-custom-arrow slick-prev"> <i class="fas fa-chevron-left"></i> </button>',
    nextArrow: '<button type= "button" class="slick-custom-arrow slick-next"> <i class="fas fa-chevron-right"><i> </button>',
    speed: 700,
    slideToShow: 2,
    slideToScroll: 2,
});
